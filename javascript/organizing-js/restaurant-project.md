...
1.some instructions here on whether or not to create a separate css file or include stylings in the javascript as well. also where to put the css file --> src or dist folder
